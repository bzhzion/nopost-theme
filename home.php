<?php
/**
 * nopost — home.php (blog listing, when page_for_posts is set)
 */
get_header();
?>
...
<div class="np-section__inner">
  ...
  <div class="np-page-header">
    <h1 class="np-page-title"><?php esc_html_e( 'Articles', 'nopost' ); ?></h1>
  </div>
  ...
  <?php else : ?>
  <p class="np-no-results"><?php esc_html_e( 'Aucun article trouvé.', 'nopost' ); ?></p>
  <?php endif; ?>
